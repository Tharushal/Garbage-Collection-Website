...
include_once 'locations-model.php';
?>
...
<script>
    ...
    function initMap() {
        var france = {lat: 6.927079, lng: 79.861244};
    ...
    function saveData() {
        ...
        var url = 'locations-model.php?confirm_location&id=' + id + '&confirmed=' + confirmed ;
...
<div style="display: none" id="form">
    <table class="map1">
        ...
        <tr>
            ...
            <td><b>Reject Location ?:</b></td>
            <td><input id='reject' type='checkbox' name='reject'></td>
        </tr>
